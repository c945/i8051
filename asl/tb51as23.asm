...
;
        ORG     0003H
DD012:  JMP     1003H           ;External interrupt 0 service routine.
;
        DB      0,0,0,0,0
        ORG     000BH
DD014:  JMP     100BH           ;Timer 0 service routine.
;
        DB      0,0,0,0,0
        ORG     0013H
DD016:  JMP     1013H           ;External interrupt 1 service routine.
;
        DB      0,0,0,0,0
        ORG     001BH
DD018:  JMP     101BH           ;Timer 1 service routine.
;
        DB      0,0,0,0,0
        ORG     0023H
DD020:  JMP     1023H           ;Serial port interrupt service routine.
;
;$EJECT
;
...
;
DD005:  JNB     RI,$            ;Wait until character received.
